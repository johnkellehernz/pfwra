...
MIGRATION_MODULES = {"sites": "pfwra.contrib.sites.migrations"}
...
ADMINS = [("""Jordi Tablada""", "hello@jordi.nz")]
...
# # https://django-allauth.readthedocs.io/en/latest/configuration.html
# ACCOUNT_ADAPTER = "pfwra.users.adapters.AccountAdapter"
# # https://django-allauth.readthedocs.io/en/latest/configuration.html
