...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('common', '0004_auto_20210512_0421'),
        ('news', '0001_initial'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='blogpage',
            name='suburb',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='page_set', to='common.suburb'),
        ),
    ]
